...
import com.example.perfumeshop.presentation.features.profile.components.Option
import com.example.perfumeshop.presentation.features.profile.components.OptionsSection
import com.example.perfumeshop.presentation.features.profile.components.ProfileSection
...
fun RegisteredSection(
    ...
    LazyColumn{
        ...
        item(key = 1) {
            ContactsSection(onOptionClick = onOptionClick)
        }
    }
}
...
@Composable
fun ContactsSection(onOptionClick: (OptionType) -> Unit) {
    val context = LocalContext.current
