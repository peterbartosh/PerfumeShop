...
class AuthViewModel @Inject constructor(
    ...
    fun notifyAdmin(
        ...
        Log.d("SOJKOS", phoneNumber)

        val isInBlackListRes =
            withContext(Dispatchers.Default) {
                fireRepository.isInBlackList(phoneNumber)
            }
        ...
        val phoneNumberIsNotUsedYet =
            withContext(Dispatchers.Default) {
                fireRepository.phoneNumberIsNotUsedYet(phoneNumber)
            }

        Log.d("SOJKOS", phoneNumberIsNotUsedYet.toString())

        if (!phoneNumberIsNotUsedYet){
        ...
        val existingRequest = async{roomRepository.getRegistrationRequest(phoneNumber)}.await()
    ...
    private fun register(
        ...
        if (
            ...
            registrationResult?.isFailure == true){
            val message = try {
